  ...
  return (
    <div className="recipe-card">
      <div className="recipe-image-container">
        <div className="recipe-name">{imageName}</div>
        <img
          className="recipe-image"
          src={config.imagePath + item.image}
          alt="Image of craftable item"
        />
        <div className="recipe-increment-indicator">{`x${
      ...
      <div className="recipe-crafting-container">
        <div className="recipe-crafting-amount-container">
          <input
            ...
            step={item.craftedAmount}
            onChange={handleChange}
          />
        </div>
        <div className="required-items-container">
          {item.requiredItems.map(
            (requiredItem: RequiredItem, index: number) => {
              let requiredItemTotal = item.craftedAmount
                ? (requiredItem.amount * Number(craftingAmount)) /
                  item.craftedAmount
                : requiredItem.amount * Number(craftingAmount);
              return (
                <RequiredItemCard
